...
当前 Windows 正式版为 [Miao v0.1.2](https://github.com/shamikabeike/CodexPet/releases/tag/v0.1.2)：

- [`Miao-0.1.2-x64-nsis.exe`](https://github.com/shamikabeike/CodexPet/releases/download/v0.1.2/Miao-0.1.2-x64-nsis.exe)：安装版；
- [`Miao-0.1.2-x64-portable.exe`](https://github.com/shamikabeike/CodexPet/releases/download/v0.1.2/Miao-0.1.2-x64-portable.exe)：便携版；
- [`SHA256SUMS.txt`](https://github.com/shamikabeike/CodexPet/releases/download/v0.1.2/SHA256SUMS.txt)：SHA-256 校验清单。
...
npm.cmd run screenshots:generate # 构建并生成三张当前界面截图
